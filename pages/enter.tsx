    ...
    <div className="mt-16">
      ...
      <div className="mt-8">
        <div className="flex flex-col items-center ">
          <h5 className="text-sm font-medium text-orange-400">Enter using:</h5>
        ...
        <form className="mt-8 flex flex-col">
          ...
          <button className="mt-6 rounded-md border border-transparent bg-orange-500 py-2 px-4 text-sm font-medium text-white shadow-sm transition hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2">
